...
const NavBar = () => {
  return (
    <div className='contenedor'>
      ...
      <ul className='nav'>
        <NavLink to={`/catalogo`} className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>
          <li type="none">Catalogo</li>
        </NavLink>
        <NavLink to={`/category/men's clothing`} className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>
          <li type="none">Ropa Masculina</li>
        </NavLink>
        <NavLink to={`/category/jewelry`} className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>
          <li type="none">Joyas</li>
        </NavLink>
        <NavLink to={`/category/electronics`} className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>
          <li type="none">Electronica</li>
        </NavLink>
        <NavLink to={`/category/women's clothing`} className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>
          <li type="none">Ropa Femenina</li>
        </NavLink>
        <NavLink to={`/cart`} className="link">
          <li type="none">{<CartWidget />}</li>
        </NavLink>
      </ul>
    </div>
  );
